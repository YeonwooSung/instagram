...
CREATE TABLE IF NOT EXISTS follows (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT NOW(),     -- When follow relationship was created
    updated_at TIMESTAMP NOT NULL DEFAULT NOW(),     -- When status was last updated
...
-- GRANT SELECT, INSERT, UPDATE, DELETE ON follows TO instagram_user;
-- GRANT SELECT, INSERT, UPDATE, DELETE ON user_graph_stats TO instagram_user;
